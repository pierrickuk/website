...
<h2>Hatoholとは</h2>
<p>
	Hatoholは、複数の運用管理ツールのハブとなるツールです。<br>
	現在はZabbixとNagiosに対応しており、複数の監視サーバーを用いて監視を行っている場合に、それらの蓄積する監視情報をまとめて表示する、インターフェースとしての機能を持っています。<br>
	今後ジョブ管理やインシデント管理、ログ管理など、様々なツールに対応することで、あらゆる機能を備えた統合運用管理ツールと同等の機能を実現していく予定です。
</p>
